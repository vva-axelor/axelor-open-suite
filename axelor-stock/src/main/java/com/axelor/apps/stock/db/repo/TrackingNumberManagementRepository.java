...
public class TrackingNumberManagementRepository extends TrackingNumberRepository {
  ...
  protected TrackingNumberUtilsService trackingNumberUtilsService;
  ...
  public TrackingNumberManagementRepository(
      ...
      TrackingNumberUtilsService trackingNumberUtilsService) {
    this.appStockService = appStockService;
    this.barcodeGeneratorService = barcodeGeneratorService;
    this.productCompanyService = productCompanyService;
    this.stockLocationLineFetchService = stockLocationLineFetchService;
    this.trackingNumberUtilsService = trackingNumberUtilsService;
  }
  ...
  public TrackingNumber save(TrackingNumber trackingNumber) {
    ...
    try {
      ...
      trackingNumberUtilsService.getOriginParents(trackingNumber);
    } catch (Exception e) {
